        ...
        <div className="flex items-center gap-1 sm:gap-3">
          ...
          <div className="hidden md:block relative" ref={dropdownRef}>
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-200">Jordan Reeves</span>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-[#1a1d27] border border-gray-100 dark:border-white/10 rounded-xl shadow-lg py-1 z-50">
                <Link href="/profile" onClick={() => setDropdownOpen(false)} className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                  <User size={14} className="text-gray-400" /> My Profile
                </Link>
                <Link href="/applications" onClick={() => setDropdownOpen(false)} className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                  <Settings size={14} className="text-gray-400" /> My Applications
                </Link>
