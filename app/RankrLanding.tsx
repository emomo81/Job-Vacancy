    ...
    <div style={{ fontFamily: font }} className="min-h-screen bg-[#f0f5fa]">
      ...
      <header className="bg-[#070707] sticky top-0 z-50">
        <div className="max-w-[1280px] mx-auto px-6 h-16 flex items-center justify-between">
          {/* Logo */}
          <Link to="/RankrLanding" className="flex items-center gap-2 select-none">
          ...
          <div className="flex items-center gap-3">
            <Link to="/RankrDashboard" className="hidden sm:inline-flex px-5 py-2 rounded-full text-sm font-semibold text-white border border-white/30 hover:border-white/60 hover:bg-white/5 transition-all cursor-pointer">
              Sign In
            </Link>
            <Link to="/RankrDashboard" className="inline-flex items-center gap-1.5 px-5 py-2 rounded-full text-sm font-semibold text-white bg-[#2a85ff] hover:bg-[#1a75ef] shadow-[0_4px_16px_rgba(42,133,255,0.4)] hover:shadow-[0_4px_20px_rgba(42,133,255,0.55)] transition-all cursor-pointer">
              Get Started
            </Link>
          </div>
        </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Link to="/RankrDashboard" className="flex items-center gap-2 px-8 py-3.5 rounded-full text-base font-bold text-white bg-[#2a85ff] hover:bg-[#1a75ef] shadow-[0_6px_28px_rgba(42,133,255,0.45)] hover:shadow-[0_8px_36px_rgba(42,133,255,0.6)] transition-all cursor-pointer">
                  Post a Job
                  <ArrowRight size={17} strokeWidth={2.5} />
                </Link>
                <Link to="/RankrDashboard" className="flex items-center gap-2 px-8 py-3.5 rounded-full text-base font-semibold text-white border border-white/25 hover:border-white/50 hover:bg-white/5 transition-all cursor-pointer">
      ...
      <section className="bg-[#f0f5fa] py-6 pb-20">
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="pt-2">
              <Link to="/RankrDashboard" className="inline-flex items-center gap-2 px-7 py-3 rounded-full text-sm font-bold text-white bg-[#2a85ff] hover:bg-[#1a75ef] shadow-[0_4px_16px_rgba(42,133,255,0.35)] hover:shadow-[0_4px_20px_rgba(42,133,255,0.5)] transition-all cursor-pointer">
                Post a Job
          ...
          >
            ...
            <div className="pt-2 relative z-10">
              <Link to="/RankrDashboard" className="inline-flex items-center gap-2 px-7 py-3 rounded-full text-sm font-bold text-[#070707] bg-white border-2 border-[#070707] hover:bg-[#070707] hover:text-white transition-all cursor-pointer">
                Create Profile
                <ArrowRight size={15} strokeWidth={2.5} />
              </Link>
            </div>
